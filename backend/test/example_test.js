...
const chai = require('chai'); // assertion library used for writing test code
const chaiHttp = require('chai-http');
const http = require('http');
const app = require('../server'); 
const connectDB = require('../config/db');
const mongoose = require('mongoose'); // used to genereate mock objectid values
const sinon = require('sinon'); // library used for mocking/stubbing functions (so we don't hit the actual database)
const Task = require('../models/Task'); // mongoose model for task collection
const { updateTask,getTasks,addTask,deleteTask } = require('../controllers/taskController');
const { expect } = chai; // extracted from chai, used for making assertions

chai.use(chaiHttp);
let server;
let port;

// test suit that groups all test cases related to the createtask function of the task controller
